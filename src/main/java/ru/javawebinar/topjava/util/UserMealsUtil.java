...
public class UserMealsUtil {
    ...
    public static void main(String[] args) {
        ...
        List<UserMealWithExceed> filteredMealsWithExceed = getFilteredWithExceed(MEAL_LIST, LocalTime.of(7, 0), LocalTime.of(12, 0), 2000);
    ...
    public static List<UserMealWithExceed> getFilteredWithExceedByCycle(List<UserMeal> mealList, LocalTime startTime, LocalTime endTime, int caloriesPerDay) {
        ...
        for (UserMeal meal: mealList) {
            ...
            if (DateTimeUtil.isBetweenHalfOpen(dateTime.toLocalTime(), startTime, endTime)) {
